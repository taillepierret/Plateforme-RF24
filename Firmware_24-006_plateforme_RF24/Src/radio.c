...
RADIO_state_receive_packet_en RADIO_state_receive_packet_EN = RADIO_RECEIVE_TRANSITION_TO_WAITING_FOR_RECEIVE_PACKET_EN;
...
static void RADIO_SendStateMachine(void)
{
    ...
    switch(RADIO_state_send_packet_EN)
    {
        ...
        case RADIO_SEND_SENDING_PACKET_EN:
            if(retry_counter_U8 < NUMBER_OF_RETRY_MAX_U8)
            {
                ...
                if(NRF_ret_val_EN == NRF_OK_EN)
                {
                    ...
                    beginnning_send_time_U32 = HAL_millis_U32();
        ...
        case RADIO_SEND_WAITING_ACK_EN:
            ...
            else if(HAL_millis_U32() - beginnning_send_time_U32 > TIMEOUT_ACKNOWLEDGE_ms_U32)
            {
                retry_counter_U8++;
                beginnning_send_time_U32 = 0;
                RADIO_state_send_packet_EN = RADIO_SEND_SENDING_PACKET_EN;
